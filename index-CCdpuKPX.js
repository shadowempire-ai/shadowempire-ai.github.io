...
`).join(``);document.querySelector(`#app`).innerHTML=`
  ...
  <main id="top">
    ...
    <section class="signal-bar" aria-label="Clan statistics"><div><span class="stat-number">24</span><span>active members</span></div><div><span class="stat-number">18</span><span>builds shipped</span></div><div><span class="stat-number">04</span><span>years together</span></div><div class="signal-note"><span class="pulse"></span> Website online <a href="https://iamstar753-dotcom.github.io/index.html" target="_blank" rel="noopener noreferrer">iamstar753-dotcom.github.io</a></div></section>
