(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{name:`Gravexis`,role:`Warden`,color:`#e47b42`,initial:`G`,status:`online`},{name:`Ajaybhai64`,role:`Architect`,color:`#8aaa76`,initial:`A`,status:`online`},{name:`Nyx`,role:`Redstone`,color:`#c56b67`,initial:`N`,status:`away`},{name:`Hearth`,role:`Scout`,color:`#d7ad6c`,initial:`H`,status:`online`}].map(e=>`
  <li class="member-row">
...
`).join(``);document.querySelector(`#app`).innerHTML=`
  ...
  <main id="top">
    ...
    <section class="signal-bar" aria-label="Clan statistics"><div><span class="stat-number">95</span><span>active members</span></div><div><span class="stat-number">18</span><span>builds shipped</span></div><div><span class="stat-number">1</span><span>years together</span></div><div class="signal-note"><span class="pulse"></span> Website online <a href="https://shadowempire-ai.github.io/index.html" target="_blank" rel="noopener noreferrer">shadowempire-ai.github.io</a></div></section>
